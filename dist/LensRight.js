...
var LensRight = function LensRight(_ref) {
    ...
    var width = (0, _lodash2.default)(smallImage.width - cursorPosition.x - cursorOffset.x, 0, maxWidth);
    var translateY = (0, _lodash2.default)(Math.round(cursorPosition.y - cursorOffset.y), 0, maxHeight);
    var computedStyle = {
        height: height + 'px',
        width: width + 'px',
        top: '0px',
